...
class Trainer(TrainBase):
    ...
    def _init_model(self):
        ...
        args = Namespace(n_bits=self.args.output_dim, n_classes=self.args.n_classes, scale=23.0, ps_alpha=0.80,
                         ps_mu=0.6, method=1)
    ...
    def _init_dataset(self):
        ...
        self.args.index_file = os.path.join("/home/admin01/li-kun/dataset", self.args.dataset, self.args.index_file)
        self.args.caption_file = os.path.join("/home/admin01/li-kun/dataset", self.args.dataset, self.args.caption_file)
        self.args.label_file = os.path.join("/home/admin01/li-kun/dataset", self.args.dataset, self.args.label_file)
    ...
    def train_epoch(self, epoch):
        ...
        for image, text, label, index in self.train_loader:
            ...
            loss = loss_image + loss_text + 0.001*loss_quantization_image + 0.001*loss_quantization_text
            all_loss += loss
