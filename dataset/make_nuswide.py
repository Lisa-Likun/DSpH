...
root_dir = "/home/admin01/li-kun/dataset/nuswide"
...
imagePath = os.path.join(root_dir, "Flickr")
...
with open(os.path.join(root_dir, "Groundtruth/used_label.txt")) as f:
...
not_used_id = []
with open(os.path.join(root_dir, "Groundtruth/not_used_id.txt")) as f:
...
scio.savemat(os.path.join(root_dir, "index.mat"), indexs)
# scio.savemat("caption.mat", captions)
scio.savemat(os.path.join(root_dir, "label.mat"), labels)


captions = [item + "\n" for item in captions["caption"]]

with open(os.path.join(root_dir, "caption.txt"), "w") as f:
